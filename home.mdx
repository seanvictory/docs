...
<CardGroup>
  <Card title="Getting Started" icon="rocket" href="/getting-started/introduction" horizontal />
</CardGroup>
...
<CardGroup>
  <Card title="Integration Providers" icon="link" href="/resources/integrations" horizontal />

  <Card title="SDK / API Reference" icon="puzzle-piece" href="/api/api-reference" horizontal />

  <Card title="Tutorials" icon="sparkles" href="/tutorials">
...
<CardGroup>
  <Card title="Building a Salesforce Integration" icon="salesforce" href="/tutorials/building-a-salesforce-integration" horizontal />

  <Card title="Building a HubSpot Integration" icon="hubspot" href="/tutorials/building-a-hubspot-integration" horizontal />

  <Card title="Building a Slack Integration" icon="slack" href="/tutorials/building-a-slack-integration" horizontal />
</CardGroup>