...
<CardGroup>
  <Card
    title="Paragon - Demo Mode"
    icon="play"
    href="https://demo.useparagon.com"
    horizontal
  />
</CardGroup>
<Accordion
  title="Testing an On-Premise Instnace?"
>
...
<Frame>
  <img src="/images/demo-2.avif"/>
</Frame>

## Changelog

### 2024-01-24
- Initial documentation of the Demo Environment
- Added comprehensive testing instructions for both SDK and REST API methods
- Included information about on-premise instance testing