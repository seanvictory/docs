...
Field Mapping settings can be added by visiting the "Customize Connect Portal" screen from a supported integration in your project, under the [User Settings](workflow-user-settings/) section.
...
<div><figure><img src="../.gitbook/assets/image (64).png" alt=""><figcaption><p><code>{ userCanRemoveMappings: true, defaultFields: [] }</code></p></figcaption></figure> <figure><img src="../.gitbook/assets/image (13).png" alt=""><figcaption><p><code>{ userCanRemoveMappings: true,</code><br><code>defaultFields: ["title"] }</code></p></figcaption></figure></div>
...
### 2024-01-17
- Added initial changelog section to document version history
