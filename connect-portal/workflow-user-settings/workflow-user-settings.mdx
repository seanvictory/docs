...
### 2024-01-09
- Initial documentation created with comprehensive overview of User Settings
- Added sections for adding, referencing, and testing User Settings
- Included visual examples and step-by-step instructions